        ...
        <section className="about-section">
            ...
            >
                ...
                <div className="skills-card">
                    <ul className="skills-list">
                        <motion.li whileHover={{ scale: 1.1 }}>{t('about.skills.programming')}</motion.li>
                        <motion.li whileHover={{ scale: 1.1 }}>{t('about.skills.softwareTools')}</motion.li>
                        <motion.li whileHover={{ scale: 1.1 }}>{t('about.skills.frameworks')}</motion.li>
                        <motion.li whileHover={{ scale: 1.1 }}>{t('about.skills.projectManagement')}</motion.li>
                        <motion.li whileHover={{ scale: 1.1 }}>{t('about.skills.database')}</motion.li>
                        <motion.li whileHover={{ scale: 1.1 }}>{t('about.skills.languages')}</motion.li>
                    </ul>
                    <button
                        className="expand-btn"
                        onClick={() => setShowSkillsDetails(!showSkillsDetails)}
                    >
                        {showSkillsDetails ? t('about.skills.readLess') : t('about.skills.readMore')}
                    </button>
                    {showSkillsDetails && (
                        <motion.div
            ...
            >
                ...
                <div className="experience-card">
                    ...
                    >
                        {showExperienceDetails ? t('about.skills.readLess') : t('about.skills.readMore')}
                    </button>
                    {showExperienceDetails && (
                        ...
                        >
                            ...
                            <div className="timeline-item">
                                <h4>{t('about.experience.internationalMotivation.title')}</h4>
                                <ul>
            ...
            >
                ...
                <div className="education-card">
                    <p><strong>{t('about.education.master.title')}</strong> – {t('about.education.master.institution')}</p>
                    <button
                        className="expand-btn"
                        onClick={() => setShowMasterDetails(!showMasterDetails)}
                    >
                        {showMasterDetails ? t('about.skills.readLess') : t('about.skills.readMore')}
                    </button>
                    {showMasterDetails && (
                        <motion.div
                            className="expanded-content"
                    ...
                    <p><strong>{t('about.education.bachelor.title')}</strong> – {t('about.education.bachelor.institution')}</p>
                    <button
                        className="expand-btn"
                        onClick={() => setShowBachelorDetails(!showBachelorDetails)}
                    >
                        {showBachelorDetails ? t('about.skills.readLess') : t('about.skills.readMore')}
                    </button>
                    {showBachelorDetails && (
                        <motion.div
                            className="expanded-content"
